...
class ResourceNotFoundException extends NotFoundException
{
    ...
    {
        parent::__construct(sprintf("Resource '%s' with id '%s' not found.".(empty($validIdentifiers) ? '' : ' Valid identifiers are: %s.'), $resourceName, $identifier, implode(',', $validIdentifiers)));
    }
}
